...
public partial class Registering : System.Web.UI.Page
    {
        ...
        LabelWarning.Text = BLLUser.InsertEnterpriseAdress(new EnterpriseUserAdress {  city = TextBoxCity.Text, building_name = TextBoxBuildingName.Text, district = TextBoxDistrict.Text, neighbourhood = TextBoxNeighbourhood.Text, zip_code = TextBoxZipCode.Text });
        LabelWarning.Text = BLLUser.InsertEnterprise(new EnterpriseUser {   tax_no = TextBoxTaxNumber.Text, corporation_title = TextBoxCorporationTitle.Text, });
        LabelWarning.Text = BLLUser.Login(new UserLogin { email = TextBoxEmail.Text, password = TextBoxPassword.Text });
